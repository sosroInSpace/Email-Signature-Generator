         ...
         <tbody>
          <tr>
           <td style="padding:0;font-family:'helvetica neue',helvetica,sans-serif;height:55px; vertical-align:top; text-align:left;" valign="top" align="left" width="175">
            <span style="font-family:'helvetica neue',helvetica,sans-serif;font-size:14pt; font-weight:bold;color:#50abb9;font-size:11pt;letter-spacing:1px;text-transform:uppercase">${ this.props.name }<span><br></span></span>
          ...
          <tr>
           <td style="padding:0;height:29px; font-family:'helvetica neue',helvetica,sans-serif;vertical-align:top;padding-top:10px" valign="top" align="left">
            <a href="https://okmg.com" target="_blank"><img nosend="1" alt="Logo" style="height:20px; width:89; border:0; " height="20" border="0"  src="https://s3-ap-southeast-2.amazonaws.com/okmg-email-signatures/okmg/ok-new.png"></a>
           </td>
          </tr>
          <tr>
           <td style="padding:0;font-family:'helvetica neue',helvetica,sans-serif;height:20px; vertical-align:middle; text-align:left;padding-top:6px" valign="middle" align="left">
            <span><a href="https://www.facebook.com/OKMGAustralia/" target="_blank"><img nosend="1" border="0" width="20" alt="Facebook icon" style="border:0; height:20px; width:20px" src="https://s3-ap-southeast-2.amazonaws.com/okmg-email-signatures/okmg/ESIG_ICONS-01.png"></a></span>
            <span><a href="https://www.instagram.com/okmg.agency/" target="_blank"><img nosend="1" border="0" width="20" alt="Instagram icon" style="border:0; height:20px; width:20px" src="https://s3-ap-southeast-2.amazonaws.com/okmg-email-signatures/okmg/ESIG_ICONS-02.png"></a> </span>
           </td>
          </tr>
         </tbody>
        </table>
         ...
         <tbody>
          ...
          <tr>
           <td style="padding:0;font-family:'helvetica neue',helvetica,sans-serif;height:40px; vertical-align:top; padding:0; text-align:left;" valign="top" align="left">
            <span style="font-family:'helvetica neue',helvetica,sans-serif;font-size:7pt;color:#eee;letter-spacing:1px;"><span style="color:#50abb9">P:</span> 1300 93 6564 <span><br></span></span>
            <span style="font-family:'helvetica neue',helvetica,sans-serif;font-size:7pt;color:#eee;letter-spacing:1px"><span style="color:#50abb9">M:</span> ${ this.props.mobileNumber } </span>
           </td>
          </tr>
           <tr>
